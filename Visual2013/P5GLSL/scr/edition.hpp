...
// Luces direccionales
glm::vec3 dirDirectional1 = glm::vec3(0.0, 1.0, 0.0);
glm::vec3 intensityDirectional1 = glm::vec3(1.0, 0.0, 0.0);

// Luces puntuales
glm::vec3 posPoint1 = glm::vec3(0.0, 2.0, 5.0);
glm::vec3 intensityPoint1 = glm::vec3(0.0, 0.0, 1.0);

// Luces focales
glm::vec3 dirFocal1 = glm::vec3(0.0, -1.0, 0.0);
glm::vec3 posFocal1 = glm::vec3(0.0, 10.0, 0.0);
glm::vec3 intensityFocal1 = glm::vec3(0.0, 1.0, 0.0);
float angleFocal1 = 60.0;

// Objeto 1
float angleOffset1 = 0.0;
glm::vec3 axisAngleOffset1 = glm::vec3(1.0, 0.0, 0.0);
glm::vec3 positionOffset1 = glm::vec3(10.0, 0.0, 0.0);
glm::vec3 translation1 = glm::vec3(0.0, 0.0004, 0.0);
