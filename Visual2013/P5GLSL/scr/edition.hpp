...
// Luces puntuales
glm::vec3 posPoint1 = glm::vec3(0.0, 0.0, -10.0);
...
// Objeto 1
float angleOffset1 = 0.0f;
glm::vec3 axisAngleOffset1 = glm::vec3(0.0, 0.0, 0.0);
...
void setUpScene(Scene* scene){
	...
	// MALLA 1 //
	scene->addMesh("../objects/wall.obj", "../shaders/shader.vert", "../shaders/shader.frag");
